...
public class PrincipalSI extends JFrame {
    ...
    public PrincipalSI() {
        ...
        uso.addActionListener(new ActionListener() {
            @Override
    ...
    public void RemovActionPerformed(ActionEvent evt) {
        new Excluir_SI();
    }

    public void AlterActionPerformed(ActionEvent evt) {
        new AlterarSIBusca();
    }
